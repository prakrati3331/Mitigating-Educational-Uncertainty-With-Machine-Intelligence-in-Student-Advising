"""
E-books Backend - FastAPI backend class for e-books management
"""
import logging
...
class EbooksBackend:
    """Backend class for e-books library management"""
    ...
    def __init__(self, data_dir: str = None):
        ...
        logger.info(f"EbooksBackend initialized with data directory: {self.data_dir}")
    ...
    def _initialize_data_files(self):
        ...
        if not os.path.exists(self.ebooks_file):
            ...
            logger.info(f"Created default e-books file: {self.ebooks_file}")
        ...
        if not os.path.exists(self.categories_file):
            ...
            logger.info(f"Created default categories file: {self.categories_file}")
        ...
        if not os.path.exists(self.user_progress_file):
            ...
            logger.info(f"Created user progress file: {self.user_progress_file}")
    ...
    def get_all_ebooks(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Retrieved {len(ebooks)} e-books")
            return {
                'status': 'success',
                'ebooks': ebooks,
    ...
    def get_ebooks_by_category(self, category: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Retrieved {len(filtered_ebooks)} e-books for category: {category}")
            return {
                'status': 'success',
    ...
    def get_ebooks_by_stream(self, stream: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Retrieved {len(filtered_ebooks)} e-books for stream: {stream}")
            return {
                'status': 'success',
                'ebooks': filtered_ebooks,
                'stream': stream,
    ...
    def get_ebook_details(self, ebook_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not ebook:
                logger.warning(f"E-book not found: {ebook_id}")
                raise HTTPException(status_code=404, detail="E-book not found")
            
            logger.info(f"Retrieved details for e-book: {ebook_id}")
            return {
                'status': 'success',
                'ebook': ebook
            }
    ...
    def search_ebooks(self, query: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Search for '{query}' returned {len(filtered_ebooks)} results")
            return {
                'status': 'success',
                'ebooks': filtered_ebooks,
                'query': query,
    ...
    def update_user_progress(self, user_id: str, ebook_id: str, progress_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Updated progress for user {user_id}, e-book {ebook_id}")
            return {
                'status': 'success',
    ...
    def get_popular_ebooks(self, limit: int = 10) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Retrieved {min(limit, len(sorted_ebooks))} popular e-books")
            return {
                'status': 'success',
    ...
    def get_recent_ebooks(self, limit: int = 10) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Retrieved {min(limit, len(sorted_ebooks))} recent e-books")
            return {
                'status': 'success',
                'ebooks': sorted_ebooks[:limit],
                'count': len(sorted_ebooks[:limit])
